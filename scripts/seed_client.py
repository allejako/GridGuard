...
INSERT OR REPLACE INTO schedules
    (schedule_id, user_id, load_id, scheduled_start, duration_minutes,
     power_kw, estimated_cost_sek, savings_sek, status, created_at)
VALUES
    ('demo_ev_001', 'test_user', 'ev_charger',      ?, 240, 11.0, 32.50, {ev_savings}, 'pending', ?),
    ('demo_dw_001', 'test_user', 'dishwasher',      ?, 120,  1.8,  2.10, {dw_savings}, 'pending', ?),
    ('demo_wm_001', 'test_user', 'washing_machine', ?, 90,   2.0,  1.80, {wm_savings}, 'completed', ?)
""", (
    ev_start, now,
    dw_start, now,
    wm_start, wm_start
